...
import GeoFire
import SDWebImage
class Electronics : UITableViewCell,  UICollectionViewDataSource, UICollectionViewDelegate, CLLocationManagerDelegate {
...
extension Electronics : UICollectionViewDelegateFlowLayout {
