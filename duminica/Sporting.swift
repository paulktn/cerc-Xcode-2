...
class Sporting : UITableViewCell,  UICollectionViewDataSource, UICollectionViewDelegate, CLLocationManagerDelegate {
...
extension Sporting : UICollectionViewDelegateFlowLayout {
