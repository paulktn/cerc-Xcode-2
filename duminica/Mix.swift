...
//
//
//class Mix : UITableViewCell,  UICollectionViewDataSource, UICollectionViewDelegate, CLLocationManagerDelegate {
//
//
...
//            cell.dateCell.text = "\(differenceOfDate.second!)secs."
//
//        }else if differenceOfDate.minute! > 0 && differenceOfDate.hour! == 0 {
//            cell.dateCell.text = "\(differenceOfDate.minute!)minutes ago"
//
...
//    }
//
//extension Mix : UICollectionViewDelegateFlowLayout {
//
