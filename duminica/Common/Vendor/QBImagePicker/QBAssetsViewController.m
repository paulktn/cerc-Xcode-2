...
- (void)updateSelectionInfo
{
    ...
    if (selectedAssets.count > 0) {
        ...
        if (selectedAssets.count > 1) {
            format = NSLocalizedStringFromTableInBundle(@"assets.toolbar.items-selected", @"QBImagePicker", bundle, @"assets.toolbar.items-selected");
        } else {
            format = NSLocalizedStringFromTableInBundle(@"assets.toolbar.item-selected", @"QBImagePicker", bundle, @"assets.toolbar.items-selected");
        }
    ...
    if (kind == UICollectionElementKindSectionFooter) {
        ...
        switch (self.imagePickerController.mediaType) {
            case QBImagePickerMediaTypeAny:
            {
                ...
                if (numberOfPhotos == 1) {
                    if (numberOfVideos == 1) {
                        format = NSLocalizedStringFromTableInBundle(@"assets.footer.photo-and-video", @"QBImagePicker", bundle, @"assets.footer.photo-and-video");
                    } else {
                        format = NSLocalizedStringFromTableInBundle(@"assets.footer.photo-and-videos", @"QBImagePicker", bundle, @"assets.footer.photo-and-video");
                    }
                } else if (numberOfVideos == 1) {
                    format = NSLocalizedStringFromTableInBundle(@"assets.footer.photos-and-video", @"QBImagePicker", bundle, @"assets.footer.photo-and-video");
                } else {
                    format = NSLocalizedStringFromTableInBundle(@"assets.footer.photos-and-videos", @"QBImagePicker", bundle, @"assets.footer.photo-and-video");
                }
            ...
            case QBImagePickerMediaTypeImage:
            {
                ...
                NSString *format = NSLocalizedStringFromTableInBundle(key, @"QBImagePicker", bundle, key);
