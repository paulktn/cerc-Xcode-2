...
class Construction : UITableViewCell,  UICollectionViewDataSource, UICollectionViewDelegate, CLLocationManagerDelegate {
...
extension Construction : UICollectionViewDelegateFlowLayout {
