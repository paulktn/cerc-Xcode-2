...
class Toys : UITableViewCell,  UICollectionViewDataSource, UICollectionViewDelegate, CLLocationManagerDelegate {
...
extension Toys : UICollectionViewDelegateFlowLayout {
